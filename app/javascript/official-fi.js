window.officialTranslations = {
  ...
  addTeamCompetition: 'Lisää joukkuekilpailu',
  ageGroup: 'Ikäryhmä',
  ...
  competitorsPerTeam: 'kilpailijaa / joukkue',
  ...
  editTeamCompetition: 'Muokkaa joukkuekilpailua',
  ...
  multipleTeams: 'Laske pisteet 2-joukkueille',
  nationalRecord: 'Suomen ennätys',
  ...
  showPartialTeams: 'Näytä tuloksissa myös vajaat joukkueet',
  teamCompetitorCount: 'Kilpailijoita / joukkue',
  teamCompetitionDeleteConfirmation: 'Haluatko varmasti poistaa tämän joukkuekilpailun?',
  teamCompetitionExtraShotsInfoNordic:
    'Voit tallentaa hirven uusintatuloksen ensimmäiseen kenttään ja trapin toiseen (esim. 98 ja 24)',
  teamCompetitionExtraShotsInfoShotgun:
    'Voit tallentaa kahden eri laukojan uusintalaukaukset pilkulla erotettuina (esim. 1,1,0)',
  teamCompetitionExtraShotsPlaceholder_score1: 'Hirven tulos, esim. 98',
  teamCompetitionExtraShotsPlaceholder_score2: 'Trapin tulos, esim. 24',
  teamCompetitionExtraShotsPlaceholder_shots1: 'Laukoja 1, esim: 1,0',
  teamCompetitionExtraShotsPlaceholder_shots2: 'Laukoja 2, esim: 1,0',
  teamCompetitionName: 'Kilpailun nimi',
  teamCompetitionSeriesInfoShooting: 'Valitse kaikki sarjat ja aliryhmät, jotka kuuluvat tähän joukkuekilpailuun',
  teamCompetitionSeriesInfoThreeSports: 'Valitse kaikki sarjat ja ikäryhmät, jotka kuuluvat tähän joukkuekilpailuun',
  teamCompetitionSeriesShooting: 'Sarjat ja/tai aliryhmät tässä joukkuekilpailussa',
  teamCompetitionSeriesThreeSports: 'Sarjat ja/tai ikäryhmät tässä joukkuekilpailussa',
  trackPlace: 'Ratapaikka',
  unofficial: 'Epävirallinen kilpailija',
  update: 'Päivitä',
  useTeamName: 'Muodosta joukkueet kilpailijoiden joukkuenimien perusteella',
}
