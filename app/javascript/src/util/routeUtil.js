...
export const buildSeriesStartListPath = (raceId, seriesId) =>
  withLocale(`/races/${raceId}/series/${seriesId}/start_list`)
...
export const buildSeriesShotgunsResultsPath = (raceId, seriesId) =>
  withLocale(`/races/${raceId}/series/${seriesId}/shotguns`)

export const buildNordicResultsPath = (raceId, subSport) => withLocale(`/races/${raceId}/${subSport}`)

export const buildNordicSeriesResultsPath = (raceId, seriesId, subSport) =>
  withLocale(`/races/${raceId}/series/${seriesId}/${subSport}`)

export const buildTeamCompetitionsPath = (raceId, id) => withLocale(`/races/${raceId}/team_competitions/${id}`)

export const buildRifleTeamCompetitionsPath = (raceId, id) =>
  withLocale(`/races/${raceId}/rifle_team_competitions/${id}`)

export const buildRelayPath = (raceId, relayId) => withLocale(`/races/${raceId}/relays/${relayId}`)

export const buildRelayStartListPath = (raceId, relayId) =>
  withLocale(`/races/${raceId}/relays/${relayId}/start_list.pdf`)
...
export const buildRifleCupSeriesPath = (cupId, cupSeriesId) =>
  withLocale(`/cups/${cupId}/rifle_cup_series/${cupSeriesId}`)

export const buildCupTeamCompetitionsPath = (cupId, cupTeamCompetitionId) =>
  withLocale(`/cups/${cupId}/cup_team_competitions/${cupTeamCompetitionId}`)
...
export const buildOfficialEventCompetitorNumbersSyncPath = (eventId) =>
  withLocale(`/official/events/${eventId}/competitor_numbers_sync`)

export const buildOfficialEventPrintsPath = (eventId) => withLocale(`/official/events/${eventId}/prints`)
...
export const buildOfficialRaceCompetitorsPath = (raceId, seriesId) =>
  withLocale(`/official/races/${raceId}/series/${seriesId}/competitors`)
...
export const buildOfficialRaceFinalRoundHeatListPath = (seriesId) =>
  withLocale(`/official/series/${seriesId}/final_round_heat_list`)
...
export const buildOfficialSeriesTimesPath = (raceId, seriesId) =>
  withLocale(`/official/races/${raceId}/series/${seriesId}/times`)

export const buildOfficialSeriesEstimatesPath = (raceId, seriesId) =>
  withLocale(`/official/races/${raceId}/series/${seriesId}/estimates`)

export const buildOfficialSeriesShotsPath = (raceId, seriesId) =>
  withLocale(`/official/races/${raceId}/series/${seriesId}/shots`)

export const buildOfficialRaceShootingByHeatsPath = (raceId) =>
  withLocale(`/official/races/${raceId}/shooting_by_heats`)

export const buildOfficialRaceNordicPath = (raceId, subSport) =>
  withLocale(`/official/races/${raceId}/nordic_${subSport}`)

export const buildOfficialRaceEuropeanPath = (raceId, subSport) =>
  withLocale(`/official/races/${raceId}/european_${subSport}`)

export const buildOfficialRaceCorrectDistancesPath = (raceId) =>
  withLocale(`/official/races/${raceId}/correct_estimates`)
...
export const buildOfficialRaceTeamCompetitionsPath = (raceId) =>
  withLocale(`/official/races/${raceId}/team_competitions`)
