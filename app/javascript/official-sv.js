window.officialTranslations = {
  ...
  addTeamCompetition: 'Lägg till lagtävling',
  ...
  competitorsPerTeam: 'tävlande / lag',
  ...
  editTeamCompetition: 'Redigera lagtävlingen',
  ...
  multipleTeams: 'Räkna poänger för andra lag',
  nationalRecord: 'Nationellt rekord',
  ...
  showPartialTeams: 'Visa även ofullständiga lag i resultaten',
  teamCompetitorCount: 'Tävlande / lag',
  teamCompetitionDeleteConfirmation: 'Är du säker att du vill radera den här lagtävlingen?',
  teamCompetitionExtraShotsInfoNordic:
    'Du kan spara älgs omskjutning till första fältet och traps omskjutning till den andra (t.ex. 98 och 24)',
  teamCompetitionExtraShotsInfoShotgun: 'Du kan spara två skyttars omskjutning (t.ex. 1,1,0)',
  teamCompetitionExtraShotsPlaceholder_score1: 'Älg resultat, t.ex 98',
  teamCompetitionExtraShotsPlaceholder_score2: 'Jägartrap resultat, t.ex 24',
  teamCompetitionExtraShotsPlaceholder_shots1: 'Skytt 1, t.ex: 1,0',
  teamCompetitionExtraShotsPlaceholder_shots2: 'Skytt 2, t.ex: 1,0',
  teamCompetitionName: 'Tävlingens namn',
  teamCompetitionSeriesInfoShooting: 'Välj alla klasser och sgruppar som gäller för den här lagtävlingen',
  teamCompetitionSeriesInfoThreeSports: 'Välj alla klasser och åldersgrupper som gäller för den här lagtävlingen',
  teamCompetitionSeriesShooting: 'Klasser och/eller gruppar på den här lagtävlingen',
  teamCompetitionSeriesThreeSports: 'Klasser och/eller åldersgrupper på den här lagtävlingen',
  trackPlace: 'Bana',
  unofficial: 'Informella tävlande',
  update: 'Uppdatera',
  useTeamName: 'Forma lag på grund av tävlandes lagnamn',
}
