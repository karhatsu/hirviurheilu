class Series < ActiveRecord::Base
  ...
  def ordered_competitors
    competitors.sort do |a, b|
      [a.no_result_reason.to_s, b.points.to_i, b.shot_points.to_i, b.time_points, b.points!.to_i] <=>
        [b.no_result_reason.to_s, a.points.to_i, a.shot_points.to_i, a.time_points, a.points!.to_i]
    end
  end
