      ...
      results.each do |result|
        ...
        if competitor
          ...
          unless competitor.save
            errors << "#{I18n.t('official.batch_results.competitor_save_error', track_place: place)}: #{competitor.errors.full_messages.join('. ')}"
          end
        else
          errors << I18n.t('official.batch_results.competitor_not_found', track_place: place)
        end
      end
