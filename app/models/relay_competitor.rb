class RelayCompetitor < ApplicationRecord
  ...
  def estimate_penalty_seconds
    relay.estimate_penalty_seconds * estimate_penalties.to_i
  end

  def shooting_penalty_seconds
    relay.shooting_penalty_seconds * misses.to_i
  end
