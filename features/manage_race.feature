Feature: Manage race
  ...
  Scenario: Create new race without default series
    ...
    And I select the current year from "race_start_date_1i"
  ...
  Scenario: Edit race and series
    ...
    And the page title should contain "New name for race"
    And the page title should contain "New race location"
