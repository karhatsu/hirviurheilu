Feature: Export race
  ...
  Scenario: Export finished race from offline to online
    ...
    Then the "competitor_shot_0" field should contain "10"
    And the "competitor_shot_1" field should contain "10"
    And the "competitor_shot_2" field should contain "9"
    And the "competitor_shot_3" field should contain "9"
    And the "competitor_shot_4" field should contain "9"
    And the "competitor_shot_5" field should contain "8"
    And the "competitor_shot_6" field should contain "7"
    And the "competitor_shot_7" field should contain "6"
    And the "competitor_shot_8" field should contain "5"
    And the "competitor_shot_9" field should contain "0"
