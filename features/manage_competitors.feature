Feature: Manage competitors
  ...
  Scenario: When race has series but no competitors
    ...
    Then I should see "Et ole lisännyt sarjoihin vielä yhtään kilpailijaa. Aloita klikkaamalla sarjan nimen alla olevaa nappia." in an info message
    When I go to the official competitors page of the series
    Then I should see "Et ole lisännyt tähän sarjaan vielä yhtään kilpailijaa." in an info message
