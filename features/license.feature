Feature: License
  ...
  Scenario: Show activation key
    ...
    And I should see "Mathew Stevensson (license@hirviurheilu.com)" in the email body
    And I should see "Testiseura" in the email body
    And I should see "CC81E12F02" in the email body
