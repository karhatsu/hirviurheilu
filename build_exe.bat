...
CALL cd ..
CALL ocra elk_sports\start.rb elk_sports --no-dep-run --add-all-core --gemfile elk_sports\Gemfile-windows --dll sqlite3.dll --output hirviurheilu.exe --icon elk_sports\public\favicon.ico -- server
