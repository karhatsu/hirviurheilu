...
describe ChildFormHelper do
  ...
  describe '#remove_child_link' do
    ...
    it 'should return hidden _destroy field and button with onclick call to remove_fields javascript' do
      expect(helper.remove_child_link(value, form, hide_class, confirm_question, class_names)).
          to eq("<hidden-field/><input type=\"button\" value=\"Add child\" onclick=\"remove_fields(this, &#39;hide_class&#39;, &#39;Are you sure?&#39;);\" class=\"form-class\" />")
    end
  end
  ...
  describe '#add_child_link' do
    ...
    context 'without id' do
      it 'should return button with onclick call to insert_fields javascript as escaped' do
        expect(helper.add_child_link(value, form, method, nil, class_names)).
            to eq('<input type="button" value="Add child" onclick="insert_fields(this, &quot;method&quot;, &quot;&lt;div id=\\&quot;f\\&quot;&gt;fields&lt;\\/div&gt;&quot;);" class="form-class" />')
      end
    end
    ...
    context 'with id' do
      ...
      it 'should return button with id and onclick call to insert_fields javascript' do
        expect(helper.add_child_link(value, form, method, id, class_names)).
            to eq('<input type="button" value="Add child" onclick="insert_fields(this, &quot;method&quot;, &quot;&lt;div id=\\&quot;f\\&quot;&gt;fields&lt;\\/div&gt;&quot;);" id="my-id" class="form-class" />')
      end
    end
  end
end
